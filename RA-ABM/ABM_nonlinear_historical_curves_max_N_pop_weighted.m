function [rain_field_esti,is_par,Incentive_rec]=ABM_nonlinear_historical_curves_max_N_pop_weighted(rain_field_true,radar_field,gauge_xy,...
...
for i=1:N_event
    ...
    for t=1:T
        ...
        P_weight=1./(pop_den.^power);
        Incentive(:,t)=maximum_N_weighted_nonlinear(coeff,idx(:,t),P_weight,...
                                                    budget,is_know);
