function [results]=ABM_eval_historical_max_N_multi_weighted(rain_field_true,radar_field,gauge_xy,...
											budget,alpha_P,max_par,min_par,rate,params,...
											X,Y,folder,N_cluster,window_size,power_P,power_V,k,loop_ID)
...
N_event=length(rain_field_true);
	...
	[rain_field_esti,response,Incentive]=ABM_nonlinear_historical_curves_max_N_multi_weighted(rain_field_true,radar_field,gauge_xy,...
